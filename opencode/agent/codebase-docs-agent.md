...
- Effect.ts - `~/code/.coding-agents/resources/effect`
- Neverthrow - `~/code/.coding-agents/resources/neverthrow`
- OpenCode - `~/code/.coding-agents/resources/opencode`
...
Special instructions for Neverthrow:
